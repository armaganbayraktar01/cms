<!-- SAYFA: /cms/admin/view/index.php -->

<!-- <div class="aa">
<?php //echo __DIR__ . '/index.php'; ?>
</div> -->
...
<ul>
    ...
    <li class="<?= (route(1) == $menu_url) || isset($menu['submenus'][route(1)]) ? 'active': null?>"> 
        ...
        <ul class="sub-menu">
            ...
            <li>
                <a href="<?= editor_url($submenu_url); ?>"><?=$submenu_title;?></a>
            </li>
            <?php endforeach; ?>
        </ul>
        <?php endif; ?>
