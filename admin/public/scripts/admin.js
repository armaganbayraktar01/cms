$(function () {
    ...
    //Tinymce 
    //plugins:fullpage özelliğini silerek body etiketlerini kaldırdık
    tinymce.init({
       ...
       // image_advtab: true,
        ...
        filemanager_access_key: "ab123",
        language_url: 'public\scripts\langs\tr_TR.js'  // site absolute URL
    });
    ...
    //tags input
    $('.tagsinput').tagsInput({
        placeholder: 'Etiketlerin arasını virgül ile ayırın',
        'autocomplete': {
            source: tags
        }
    });
